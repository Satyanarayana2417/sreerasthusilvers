...
A beautiful, modern e-commerce landing page for a luxury jewelry store.
...
You can deploy this project using Vercel, Netlify, or any other static hosting service.

## Credits

Built with ❤️ by **Shiva** from **Dream Team Services**
