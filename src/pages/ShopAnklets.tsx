...
const ShopAnklets = () => {
  ...
  // Real-time listener for anklets from Firebase
  useEffect(() => {
    console.log('ShopAnklets: Setting up real-time listener...');
    setLoading(true);
    
    const unsubscribe = subscribeToProductsBySubcategory('Anklets', (fbProducts) => {
      console.log('ShopAnklets: Real-time update received:', fbProducts.length, 'products');
      const uiProducts = adaptFirebaseArrayToUI(fbProducts);
      console.log('ShopAnklets: Adapted UI products:', uiProducts);
    ...
    return () => {
      console.log('ShopAnklets: Cleaning up real-time listener');
      unsubscribe();
    };
  }, []);
          ...
          <div className="container-custom">
            ...
            >
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto" style={{ fontFamily: "'Poppins', sans-serif" }}>
                Discover our exquisite collection of silver anklets
              </p>
              {/* Breadcrumb */}
              <div className="mt-3 text-sm text-muted-foreground">
                ...
                <span className="mx-2">/</span>
                <span className="text-foreground">Anklets</span>
              </div>
            </motion.div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
              {loading ? (
                ...
                <div className="col-span-full py-16 text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-2">No Anklets Available</h3>
