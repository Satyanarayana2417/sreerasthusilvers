...
const AntiqueSilverDecor = () => {
  ...
  useEffect(() => {
    setLoading(true);
    const unsubscribe = subscribeToProductsBySubcategory('Antique Silver Décor', (fbProducts) => {
  ...
  const sortedProducts = useMemo(() => {
    ...
    switch (sortBy) {
      ...
      case 'best-rating': return productsCopy.sort((a, b) => {
          ...
          <div className="container-custom">
            ...
            <div className="md:hidden">
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="text-xs text-muted-foreground">
                  ...
                  <span className="mx-1">/</span>
                  <span className="text-foreground">Antique Silver Decor</span>
                </div>
              </div>
            ...
            >
              ...
              <div className="mt-3 text-sm text-muted-foreground">
                ...
                <a href="#" className="hover:text-primary transition-colors">Furniture</a>
                <span className="mx-2">/</span>
                <span className="text-foreground">Antique Silver Décor</span>
              </div>
            </motion.div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
              {loading ? Array.from({ length: 8 }).map((_, index) => (
                ...
                <div className="col-span-full py-16 text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-2">No Décor Items Available</h3>
...
export default AntiqueSilverDecor;
