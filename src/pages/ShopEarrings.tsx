...
const ShopEarrings = () => {
  ...
  useEffect(() => {
    console.log('ShopEarrings: Setting up real-time listener...');
    setLoading(true);
    
    const unsubscribe = subscribeToProductsBySubcategory('Earrings', (fbProducts) => {
      console.log('ShopEarrings: Real-time update received:', fbProducts.length, 'products');
    ...
    return () => {
      console.log('ShopEarrings: Cleaning up real-time listener');
      unsubscribe();
    };
  }, []);
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
              {loading ? (
                ...
                <div className="col-span-full py-16 text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-2">No Earrings Available</h3>
