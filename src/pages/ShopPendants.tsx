...
const ShopPendants = () => {
  ...
  // Real-time listener for pendants from Firebase
  useEffect(() => {
    console.log('ShopPendants: Setting up real-time listener...');
    setLoading(true);
    
    const unsubscribe = subscribeToProductsBySubcategory('Pendants', (fbProducts) => {
      console.log('ShopPendants: Real-time update received:', fbProducts.length, 'products');
      const uiProducts = adaptFirebaseArrayToUI(fbProducts);
      console.log('ShopPendants: Adapted UI products:', uiProducts);
    ...
    return () => {
      console.log('ShopPendants: Cleaning up real-time listener');
      unsubscribe();
    };
  }, []);
          ...
          <div className="container-custom">
            ...
            >
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto" style={{ fontFamily: "'Poppins', sans-serif" }}>
                Discover our exquisite collection of silver pendants
              </p>
              {/* Breadcrumb */}
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
              {loading ? (
                ...
                <div className="col-span-full py-16 text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-2">No Pendants Available</h3>
