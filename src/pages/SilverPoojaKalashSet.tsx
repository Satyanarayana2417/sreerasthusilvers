...
const SilverPoojaKalashSet = () => {
  ...
  useEffect(() => {
    setLoading(true);
    const unsubscribe = subscribeToProductsBySubcategory('Silver Pooja Kalash Set', (fbProducts) => {
          ...
          <div className="container-custom">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="text-center">
              ...
              <div className="mt-3 text-sm text-muted-foreground">
                ...
                <span className="mx-2">/</span>
                <span className="text-foreground">Silver Pooja Kalash Set</span>
              </div>
            </motion.div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
              {loading ? (
                ...
                <div className="col-span-full py-16 text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-2">No Kalash Sets Available</h3>
...
export default SilverPoojaKalashSet;
