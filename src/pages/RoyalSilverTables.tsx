...
const RoyalSilverTables = () => {
  ...
  useEffect(() => {
    setLoading(true);
    const unsubscribe = subscribeToProductsBySubcategory('Royal Silver Tables', (fbProducts) => {
            ...
            <div className="md:hidden">
              ...
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="text-xs text-muted-foreground">
                  ...
                  <span className="mx-1">/</span>
                  <span className="text-foreground">Royal Silver Tables</span>
                </div>
              </div>
...
export default RoyalSilverTables;
