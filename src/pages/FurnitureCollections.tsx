...
const furnitureCategories = [
  {
    id: 1,
    title: "Silver Sofa Collection",
    description: "Luxurious silver sofas",
    image: setImg,
    href: "/furniture/silver-sofa-collection",
  },
  {
    id: 2,
    title: "Royal Silver Chairs",
    description: "Majestic silver chairs",
    image: setImg,
    href: "/furniture/royal-silver-chairs",
  },
  {
    id: 3,
    title: "Royal Silver Tables",
    description: "Elegant silver tables",
    image: setImg,
    href: "/furniture/royal-silver-tables",
  },
  {
    id: 4,
    title: "Antique Silver Décor",
    description: "Timeless silver décor",
    image: setImg,
    href: "/furniture/antique-silver-decor",
  },
  {
    id: 5,
    title: "Silver Swing (Jhoola)",
    description: "Traditional silver swings",
    image: setImg,
    href: "/furniture/silver-swing-jhoola",
  },
];
        ...
        <div className="bg-gray-50 border-b border-gray-200 hidden md:block">
          <div className="container-custom py-4">
            <div className="flex items-center gap-2 text-sm text-gray-600">
              ...
              <span>/</span>
              <span className="text-foreground font-medium">Furniture Collections</span>
            </div>
          </div>
        </div>
