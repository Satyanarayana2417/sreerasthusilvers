...
const ShopBracelets = () => {
  ...
  // Real-time listener for bracelets from Firebase
  useEffect(() => {
    console.log('ShopBracelets: Setting up real-time listener...');
    setLoading(true);
    
    const unsubscribe = subscribeToProductsBySubcategory('Bracelets', (fbProducts) => {
      console.log('ShopBracelets: Real-time update received:', fbProducts.length, 'products');
      const uiProducts = adaptFirebaseArrayToUI(fbProducts);
      console.log('ShopBracelets: Adapted UI products:', uiProducts);
    ...
    return () => {
      console.log('ShopBracelets: Cleaning up real-time listener');
      unsubscribe();
    };
  }, []);
          ...
          <div className="container-custom">
            ...
            >
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto" style={{ fontFamily: "'Poppins', sans-serif" }}>
                Discover our exquisite collection of silver bracelets
              </p>
              {/* Breadcrumb */}
              <div className="mt-3 text-sm text-muted-foreground">
                ...
                <span className="mx-2">/</span>
                <span className="text-foreground">Bracelets</span>
              </div>
            </motion.div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
              {loading ? (
                ...
                <div className="col-span-full py-16 text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-2">No Bracelets Available</h3>
