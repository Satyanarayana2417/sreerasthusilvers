...
const SilverSofaCollection = () => {
  ...
  useEffect(() => {
    console.log('SilverSofaCollection: Setting up real-time listener...');
    setLoading(true);
    
    const unsubscribe = subscribeToProductsBySubcategory('Silver Sofa Collection', (fbProducts) => {
      console.log('SilverSofaCollection: Real-time update received:', fbProducts.length, 'products');
    ...
    return () => {
      console.log('SilverSofaCollection: Cleaning up real-time listener');
      unsubscribe();
    };
  }, []);
          ...
          <div className="container-custom">
            ...
            >
              ...
              <div className="mt-3 text-sm text-muted-foreground">
                ...
                <span className="mx-2">/</span>
                <span className="text-foreground">Silver Sofa Collection</span>
              </div>
            </motion.div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
              {loading ? (
                ...
                <div className="col-span-full py-16 text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-2">No Sofas Available</h3>
                ...
                >
                  <div className="relative bg-muted rounded-xl overflow-hidden aspect-square mb-4">
                    ...
                    <div className="absolute top-3 right-3 md:opacity-0 md:translate-y-2 md:group-hover:opacity-100 md:group-hover:translate-y-0 transition-all duration-300">
                      <motion.button
                        ...
                        className={`p-2 rounded-full transition-all duration-300 ${
                          wishlist.includes(product.id) ? "text-red-500" : "text-white/90 hover:text-red-500"
                        }`}
                    ...
                    {product.oldPrice && (
                      <div className="absolute top-3 left-3 bg-destructive text-destructive-foreground text-xs font-bold px-2 py-1 rounded">SALE</div>
                    )}
                  </div>
                  <div className="space-y-2 text-center">
                    <span className="text-xs uppercase tracking-wider text-primary font-medium">{product.category}</span>
                    <h3 className="font-medium text-foreground group-hover:text-primary transition-colors text-sm md:text-base" style={{ fontFamily: "'Poppins', sans-serif" }}>
                      {product.title}
                    </h3>
...
export default SilverSofaCollection;
